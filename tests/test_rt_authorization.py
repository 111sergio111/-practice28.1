...
# 17 (Проверка кликабельности бара выбора типа авторизации)
...
# 18 (Авторизация с валидными данными)

    def test_autorization_valid_data(self):
...
# 19 (Авторизация с невалидным Email)
...
# 20 (Авторизация с некорректным номером телефона)
...
# 21 (Авторизация с некорректным паролем)
...
# 22 (Авторизация с XSS инъекцией)
