...
class TestRegistrationRT:

    def setup(self):
        self.open()

    def open(self):
        self.driver = webdriver.Chrome('Ваш путь к драйверу')
...
# 2 (Регистрация с именем из 1 буквы)
...
# 3 (Регистрация с именем из 31 буквы)
...
# 4 (Регистрация с незаполненным полем Имя)
...
# 5 (Регистрация с именем на латинице)

    def test_registration_user_with_firstname_eng_char(self):
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_FIRSTNAME).send_keys(
                Invalid_Data.first_name_eng_char)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(
                Valid_Data.valid_last_name)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_NUMBER_OR_EMAIL).send_keys(
                Invalid_Data.fake_email)
...
# 6 (Регистрация с именем из символов)

    def test_registration_user_with_first_name_symbol_char(self):
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_FIRSTNAME).send_keys(
                Invalid_Data.first_name_symbol_char)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(
                Valid_Data.valid_last_name)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_NUMBER_OR_EMAIL).send_keys(
                Invalid_Data.fake_email)
...
# 7 ('Регистрация с фамилией из 1 буквы')

    def test_registration_user_with_lastname_1char(self):
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_FIRSTNAME).send_keys(
            Valid_Data.valid_first_name)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(
            Invalid_Data.last_name_1_char)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_NUMBER_OR_EMAIL).send_keys(
            Invalid_Data.fake_email)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_PASSWORD).send_keys(
            Invalid_Data.fake_password)
...
# 8 ('Регистрация с фамилией из 31 буквы')
...
# 9 (Регистрация с незаполненным полем Фамилия)
...
# 10 (Регистрация с фамилией из символов)

    def test_registration_user_with_lastname_symbol_char(self):
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_FIRSTNAME).send_keys(
            Valid_Data.valid_first_name)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(
            Invalid_Data.last_name_symbol_char)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_NUMBER_OR_EMAIL).send_keys(
            Invalid_Data.fake_email)
        self.driver.find_element(By.ID, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_PASSWORD).send_keys(
            Invalid_Data.fake_password)
...
# 11 (регистрация email без домена)
...
# 12 (Регистрация с незаполненным обязательным полем Email или Телефон)
...
# 13 (Регистрация с паролем из 7 символа)

    def test_registration_user_with_pass_7char(self):
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_FIRSTNAME).send_keys(
                Valid_Data.valid_first_name)
        self.driver.find_element(By.XPATH, RTRegistrationLocators.LOCATOR_RT_REGISTRATION_LASTNAME).send_keys(
                Valid_Data.valid_last_name)
...
# 14 (Регистрация с паролем из 21 символа)
...
# 15 (Регистрация с паролем не содержащим цифру)
...
# 16 (Регистрация с несовпадающими паролями)
...
# Запуск тестов через терминал : python -m pytest -v --driver Chrome --driver-path
                              # <Ваш путь к драйверу> test_rt_authorization.py